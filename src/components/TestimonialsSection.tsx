      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          {testimonials.map((item) => (
            <article key={item.name} className="group relative rounded-2xl overflow-hidden bg-white p-6 shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
