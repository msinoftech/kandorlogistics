  ...
  return (
    ...
    <section className="bg-white relative sm:pt-40 md:pt-40 lg:pt-40 pt-40 pb-12">
        <div className="max-w-7xl mx-auto px-6">
            <h1 className="text-3xl md:text-4xl font-bold pb-12 text-gray-900">Power Only Units Dispatch</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold pb-6 text-gray-900">Maximise Your Fleet Efficiency with Power Only Units Dispatch Services</h2>
                    <p className="text-gray-700 leading-relaxed">Partnering with dedicated dispatching services enables owner-operators and fleet companies to concentrate on driving while reducing downtime and empty miles. Our expert team uses advanced load-matching systems to keep your trucks on the road, profitable, and compliant with industry standards nationwide.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 pt-6">
            ...
            <div className="max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Benefits for Truck Operators and Fleet Companies</h2>
                <p className="text-gray-600">To hire a dispatcher for your power-only units, you gain the advantages of expertise and technology to achieve your business goals.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        ...
                        <p className="text-gray-700">Receive 24/7 dedicated dispatch support, including real-time updates and trip tracking.</p>
                    </div>

                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">Streamlined communication, Transparent pricing, and fast load assignment</p>
                    </div>
                    
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">Save on costs related to trailer ownership, purchase, depreciation, and maintenance.</p>
                    </div>
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">Focus on driving while compliance, scheduling, and support are managed for you.</p>
                    </div>
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">Enjoy the flexibility to operate with a single tractor or a large fleet and maximise your earning potential.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section className="bg-white relative py-12">
        <div className="max-w-7xl mx-auto px-6 space-y-18">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Why Choose a Dispatcher for Your Power-Only Units?</h2>
                    <p className="text-gray-700 mb-6 leading-relaxed">With industry expertise, the Power Only Units Dispatcher matches your tractors to loads that require only a truck, not a trailer.</p>
                    <p className="text-gray-700 mb-6 leading-relaxed">Our team streamlines your trip planning and ensures every asset works at its best, whether you have a single unit or an entire fleet. We secure top-paying loads, negotiate with brokers or shippers, and handle all the paperwork for you. This gives you the freedom to drive; don’t wait for freight.</p>
                </div>
                <div className="flex-1">
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
            {/* Heading Section */}
            <div className="max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">How does our Power Only Units Dispatching service work?</h2>
                <p className="text-gray-600">We tackle the unique hurdles of this niche, turning the search for the perfect load into a smooth, hassle-free experience.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We review your equipment, preferred lanes, drivers’ schedules, and business goals.​</p>
                    </div>

                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We register your business and connect you to our load network based on your dispatch preferences.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We find and match loads to your criteria, then coordinate scheduling with you.</p>
                    </div>
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We coordinate trailer, pickup, and delivery details once you accept the loads.</p>
                    </div>
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We provide administrative support, handle documentation, coordinate billing, and track compliance.</p>
                    </div>
                    <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-3 h-3 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-gray-700">We also search for follow-up loads to minimise empty miles.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">What Do Kandor Logistics Power-Only Units Dispatchers Offer?</h2>
                <p className="text-gray-600">We guide you through smart load sequencing so you can turn every week into a profitable one, making the most of partials and expedited drops. Our mission is to cut down empty miles, boost your net per mile, and link you with partners you can count on.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-100 rounded-2xl shadow p-12 hover:shadow-lg transition">
                    ...
                    <p className="text-gray-700">We search for the right loads across multiple platforms and negotiate for the best rates, ensuring every mile is profitable.</p>
                </div>
